import { m, o, eat, match, eatMatch } from '@bablr/helpers/grammar';
...
export default class BlankSpace {
  ...
  *LeftOffset({ s }) {
    ...
    if (!span || !span.props) {
      ...
      let spaces = ' '.repeat(span.props.spaces);
      while (yield eatMatch(m`indents[]: <*Indent '${spaces}' />`, o({}), o({ literal: true }))) {}
    }
  }
